...
public class orderRealoze {
    ...
    public void addOrder(User user){
        ...
        //获取购物车信息
        ShopCart shopCart =shopCartRealize.purchaseGoodsMapper.getCartAnyGoods(orderGoodsName);
        if(shopCart!=null){
        //添加Id
        ...
        //添加成功后删除购物车对象
        shopCartRealize.purchaseGoodsMapper.deleteGoods(orderGoodsName);
        }else {
