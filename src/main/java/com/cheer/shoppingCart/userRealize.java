        ...
        for (int i = 3; i >=1 ; i--) {
            ...
            if(name.matches("\\w{6,20}")){
                if(password.matches("\\w{6,12}")){
                    ...
                    System.out.println("密码有误，字母开头，6-12位，还有"+(i-1)+"次机会请重新登录！");
                }
            }else {
                System.out.println("账号有误，字母开头，6-12位，还有"+(i-1)+"次机会请重新登录！");
            }
        }
        return user;
    }
        ...
        do {
            ...
            if (name.matches("\\w{6,20}")) {
                ...
                if (password.matches("\\w{6,12}")) {
                    ...
                    System.out.println("密码输入有误，字母开头，6-20位");
                }
            } else {
                System.out.println("账号输入有误，字母开头，6-16位");
            }
